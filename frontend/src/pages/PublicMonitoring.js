        ...
        <div className="border-t border-slate-200 bg-white/95">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-1 overflow-x-auto py-2">
              ...
              <Link to="/public/agenda" className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm text-slate-700 hover:bg-purple-50 hover:text-purple-800 transition-colors whitespace-nowrap">
      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            <Badge className="bg-amber-100 text-amber-900 border border-amber-200">Transparansi Publik</Badge>
          </div>
        ...
        {loading ? (
          ...
          <NoDataEmptyState
            ...
            description="Belum ada jadwal pelajaran untuk hari ini atau filter yang dipilih"
          />
        ) : (
