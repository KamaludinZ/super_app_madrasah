...
import { FileBarChart, Stethoscope, Pill, AlertTriangle, Loader2 } from 'lucide-react';
              ...
              <CardContent className="space-y-2">
                {summary.obat_stok_menipis.map((o) => (
                  <div key={o.id} className="flex items-center justify-between text-sm">
                    ...
                    <Badge className="bg-rose-100 text-rose-700 border-rose-200">{o.stok} {o.satuan} (min: {o.stok_minimum})</Badge>
                  </div>
                ))}
              </CardContent>
            </Card>
