...
async def list_alumni(
    ...
    user: Dict = Depends(require_role('admin', 'kepala_sekolah', 'penjamin_mutu'))
):
...
async def alumni_stats(user: Dict = Depends(require_role('admin', 'kepala_sekolah', 'penjamin_mutu'))):
