...
async def list_users(
    ...
    user: Dict = Depends(require_role('admin', 'kepala_sekolah', 'wali_kelas', 'waka_kurikulum', 'waka_kesiswaan', 'kepala_tata_usaha', 'unit_pelayanan', 'unit_kesehatan', 'penjamin_mutu'))
):
    q = {}
    if role:
        q['roles'] = role
